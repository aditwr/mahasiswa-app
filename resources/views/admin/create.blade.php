    ...
    <div class="flex justify-center pt-12">
        <div class="">
            ...
            <div class="mb-8 relative">
                <h3 class="text-2xl font-semibold">Tambah Data Mahasiswa</h3>
            </div>
            <!-- form to create new data mahasiswa -->
            ...
            <div class="flex justify-center">
                ...
                <div id="toast-success" class="flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
                    ...
                    <div class="ms-3 text-sm font-normal">Data mahasiswa berhasil disimpan.</div>
            ...
            <form action="{{ route('mahasiswa.store') }}" method="post" class="w-80 mx-auto">
                @csrf
                <!-- nim -->
                <div class="mb-5">
                ...
                <div class="">
                    ...
                    <input name="usia" type="number" id="number-input" aria-describedby="helper-text-explanation" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="" required />
                </div>
